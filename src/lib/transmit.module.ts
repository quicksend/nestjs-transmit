...
export class TransmitModule {
  ...
  private static createAsyncProviders(options: TransmitModuleAsyncOptions): Provider[] {
  ...
  private static createAsyncOptionsProvider(options: TransmitModuleAsyncOptions): Provider {
